...
<body>
                                    ...
                                    <div class="test-state d-flex justify-content-between">
                                        ...
                                        <div>
                                            <span>
                                                <i class="fa-solid fa-video text-white"></i>
                                                &nbsp;
                                                <span class="dis_retake">{{ $question->retake }}</span>/{{ $question->retake }}をリテイク</span>
                                        </div>
                                    </div>
                        ...
                        <div class="test-voice tab-content" id="tab-{{ $question->question_no }}">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    ...
                                    <div class="test-button">
                                        <button class="video-recoding" id="videoRecord{{ $question->question_no }}"
                                            onclick="video_record({{ $question->question_no }})"><i class="fa-solid fa-microphone"></i>&nbsp;&nbsp;&nbsp;今すぐ録音する</button>
                                    </div>
                                    <div class="test-state d-flex justify-content-between">
                                        <div>
                                            @if ($question->answer_time)
                        ...
                        <div class="test-writing w-100 tab-content" id="tab-{{ $question->question_no }}">
                            ...
                            <div class="input-box w-100">
                                <div class="w-100 d-flex justify-content-between px-18">
                                    ...
                                    <span class="d-block">@if ($question->limit_type == 'words') 言葉@else 文字@endif数制限: {{$question->max}}</span>
                                </div>
                            ...
                            <div class="w-100 d-flex justify-content-center align-items-baseline text-center mb-3 save_continue">
                                <button class="btn rounded-5 bg-secondary" disabled id="save_continue{{$question->question_no}}" onclick="save_continue({{$question->question_no}})">保存して続行</button>
                            </div>
                                                    ...
                                                    <div class="file-drop-zone clickable" tabindex="-1">
                                                        <div class="file-drop-zone-title">
                                                            <div class="upload-area">
                                                                ...
                                                                <div> <button class="btn_upload" onclick="select_file({{ $question->question_no }})">ブラウズ</button> </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <input class="fileupload" id="fileupload{{ $question->question_no }}" type="file" accept="*.* "
                                                        multiple=false />
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="container py-5 d-flex justify-content-center" id="welcome_message">
            <div class="card rounded-5 shadow ">
                ...
                <div class="button-group">
                    <button class="btn  rounded-5 bg-secondary" id="go_interview" onclick="start_time(1)">Go to interview</button>
                </div>
                <div class="content">
                    <p>
    ...
    <script>
                    ...
                    quill{{$question->question_no}}.on('text-change', function (delta, oldDelta, source) {
                        if (source == 'api') {
                            ...
                            if (new String(quill{{$question->question_no}}.getContents().ops[0].insert) == '\n') {
                                ...
                                $("#save_continue{{$question->question_no}}").addClass("active").removeAttr("disabled");
                            }
                        }
                    });
                @endif
        ...
        function start_time(q_no) {
            ...
            const clock_id = setInterval(function(e) {
        ...
        function make_answer(q_no){
            ...
            if(answers.length - 1 !== q_no){
                alert("The actions is incorrect.");
                return;
            }
