                ...
                <div class="position-absolute start-50 translate-middle-x w-100" style="bottom: 20vh;">
                    <div class="row rounded-pill bg-white w-100 mb-3">
                        <form action="" method="get"
                            ...
                            <div class="col-4 d-flex justify-content-between me-3">
                                ...
                                <input type="text" name="search_key" id="search_key" value="{{ old('search_key') }}"
                            ...
                            <div class="col-4 d-flex justify-content-between me-3">
                                <select name="salary_min" id="salary_min" class="form-select border-1 me-3">
                                    ...
                                    <option value="200000" @if (old('salary_min') == '200000') selected @endif>200000円
                                    </option>
                                    <option value="300000" @if (old('salary_min') == '300000') selected @endif>300000円
                                    </option>
                                    <option value="300000" @if (old('salary_min') == '300000') selected @endif>400000円
                                    </option>
                                </select>
                                <select name="salary_max" id="salary_max" class="form-select border-1">
                                    ...
                                    <option value="200000" @if (old('salary_max') == '200000') selected @endif>200000円
                                    </option>
                                    <option value="300000" @if (old('salary_max') == '300000') selected @endif>300000円
                                    </option>
                                    <option value="300000" @if (old('salary_max') == '300000') selected @endif>400000円
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="row rounded-pill w-100 justify-content-between align-items-center" id="fields">
                        @foreach ($fields as $item)
                            <div class="col-auto">
                                <button class="btn btn-primary rounded-pill" data-id="{{ $item['id'] }}"
