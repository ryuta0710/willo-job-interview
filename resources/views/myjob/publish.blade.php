        ...
        <div class="row">
            ...
            <div class="col-12 d-flex justify-content-between">
                ...
                <div class="form-check form-switch w-auto">
                    <input class="form-check-input" data-onstyle="success" id="isTip" type="checkbox" role="switch" checked>
                </div>
            </div>
            <div class="col-12 d-flex justify-content-between mt-3">
                ...
                <div class="form-check form-switch w-auto">
                    <input id="isFollow" class="form-check-input " data-onstyle="success" type="checkbox" role="switch" checked>
                </div>
            </div>
                ...
                <table class="table" id="public_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><input type="checkbox" name="send_{{$user->email}}" id=""></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
let temp = "";
	...
	while (now.getTime() < end.getTime()) {
		...
		temp += "<option value='" + now.getDate() + "'>" + now.getFullYear() + "年 " + (now.getMonth() + 1) + "月 " + now.getDate() + "日</option>"
	}
    ...
    $("#next").click(function(){
        ...
        success: function(response) {
            location.href = "{{route('invite-people',['myjob' =>$myjob ])}}"l;
        },
