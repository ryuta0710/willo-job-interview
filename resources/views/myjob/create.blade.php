                            ...
                            <g id="Layer_1" transform="translate(0.552 0.899)">
                                ...
                                <g id="Group_2214" data-name="Group 2214"
                                    ...
                                    <path id="Path_87" data-name="Path 87"
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                                        stroke-width="1" />
                                    <ellipse id="Ellipse_29" data-name="Ellipse 29" cx="1.95" cy="1.854" rx="1.95"
                                        ry="1.854" transform="translate(3.634 6.831) rotate(-44.283)" fill="#fff"
        ...
        <div class="w-100 pt-5 px-5 fs-14">
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-6">
                    <div class="mb-3 pb-2">
                        <div class="d-flex justify-content-between px-4 pb-1">
                            <label for="input1" class="form-label">ビデオの紹介 &nbsp;<svg xmlns="http://www.w3.org/2000/svg"
                                    width="13.33" height="13.33" viewBox="0 0 13.33 13.33">
                        ...
                        <input type="text" class="form-control px-4 rounded-5" id="video_url"
                            placeholder="YouTubeビデオのリンクを入力してください">
                    </div>
                </div>
            </div>
            <!-- END ROW -->
            ...
            <div class="w-100 px-5" id="description_video">
                <div class="row card rounded-4 p-4 flex-row flex-wrap">
                    <div class="col-12 col-xl-7 text-center" id="preview">
                        <svg class="w-100" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="590" height="333" viewBox="0 0 590 333">
                            <defs>
                                <linearGradient id="linear-gradient" x1="0.286" y1="-0.069" x2="0.766" y2="1.048"
            ...
            <div class="col-12 d-flex justify-content-between">
                <span>「表示のヒント」ページ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <svg xmlns="http://www.w3.org/2000/svg" width="11.656" height="11.656" viewBox="0 0 11.656 11.656">
                        ...
                        <path id="Path_94" data-name="Path 94" d="M18,20.131V18" transform="translate(-12.172 -12.172)"
                            fill="none" stroke="#a1a1a1" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1" />
