...
<main class="pt-5">
    <div class="container mb-5">
        ...
        <div class="row mt-4">
            <div id="steps" class="col-12 d-flex justify-content-center align-items-center smaller">
                ...
                <div class="d-flex flex-column align-items-center">
                    <div class="rounded-circle p-3 bg-secondary-white d-flex justify-content-center align-items-center mb-2 bg-active" style="width: 55px; height: 55px;">
    ...
    <div class="container" id="questions">
        <div class="max-710 m-auto d-flex flex-column gap-4 fs-14" id="question_box">
            <div class="card p-3 position-relative question question-video" id="question1" data-no="1">
                ...
                <div class="ps-5">
                    <input type="text" name="q_content" class="form-control border-start-0 outline-none shadow-none border-secoandary border-top-0 border-end-0 input-title q_content" placeholder="質問">
                </div>
                ...
                <div class="row m-0 mt-4 card_input">
                    <div class="col-12 col-xl-6 input-type mb-4">
                        ...
                        <div class="input-group fs-6 rounded-5">
                            ...
                            <select name="answer_type" class="form-select rounded-end-5 answer_type" id="answer_type">
                    ...
                    <div class="col-12 col-xl-6 input-retake">
                        ...
                        <div class="input-group">
                            <label class="input-group-text  rounded-start-5 bg-white border-end-0" for="retake"><i class="fa-solid fa-repeat"></i></label>
                            <select name="retake" type="text" class="form-select rounded-end-5 w50 retake" id="retake">
                    ...
                    <div class="col-12 col-xl-6 input-time">
                        ...
                        <div class="input-group">
                            ...
                            <select name="answer_time" type="text" class="form-select rounded-end-5 time" id="input1" placeholder="回答時間">
                    ...
                    <div class="col-12 col-xl-6 input-limit none">
                        ...
                        <div class="input-group">
                            <select type="text" class="form-select rounded-pill limit" id="limit" placeholder="回答時間">
                    ...
                    <div class="col-12 col-xl-6 input-max none">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control rounded-pill max" name="max" id="max" min=1 value="500" max=500 step="10">
                        </div>
                    </div>
                    <div class="col-12 col-xl-6 input-thinking-time">
                        ...
                        <div class="row">
                            <div class="input-group w-50">
                                ...
                                <input type="number" value="0" class="form-control rounded-end-5 thinking_hour" name="thinking_hour" id="thinking_hour" placeholder="時" min=0 aria-label="" aria-describedby="basic-addon1">
                            </div>
                            <div class="input-group w-50">
                                <span class="input-group-text rounded-start-5 bg-white border-end-0"><i class="fa-solid fa-hourglass-start"></i></span>
                                <input type="number" value="0" class="form-control rounded-end-5 thinking_minute" name="thinking_minute" id="thinking_minute" placeholder="分" min=0 max=59 aria-label="" aria-describedby="basic-addon1">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row card_preview fs-14 px-4">
                    ...
                    <div class="col-12 col-xl-6 input-time">
                        <p>回答の時間</p>
                        <p class="text-secondary"><i class="fa-solid fa-stopwatch"></i><span class="dis_time">1</span><span class="dis_time_minute">分</span>
                        </p>
                    </div>
                    <div class="col-12 col-xl-6 input-limit none">
                        <p>単語制限</p>
    ...
    <div class="container">
        <div class="w-100 d-flex justify-content-center align-items-baseline text-center mt-4 mb-5">
            <a href="{{ route('myjob.edit', ['myjob' => $myjob ]) }}" class="none btn  btn-normal rounded-5 bg-white border border-primary me-4" id="before">戻る</a>
