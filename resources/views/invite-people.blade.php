...
<main class="pt-5">
    <div class="container">
        ...
        <div class="row mt-3">
            <div class="mb-1">
                <h5 class="fs-5">面接タイトル <span
                        class="badge bg-light-success text-success px-3 py-1 rounded-pill">募集中</span></h5>
            </div>
            <div>
            ...
            <div class="col-lg-6 mx-auto">
                <div class="rounded-pill position-relative p-2 border">
                    <div class="col col-lg-8">
                        <input type="text" class="link-input form-control border-0 shadow-none"
                            placeholder="https://app.willotalent.com/invite/62juBk/"
                            value="https://app.willotalent.com/invite/62juBk/"
                            id="invite_url">
                        <div class="d-none d-lg-block">
                            <button
                                class="btn btn-info py-2 position-absolute rounded-pill end-0 top-50 translate-middle-y me-2 text-white"
                                type="button" style="z-index: 2;" onclick="copy()">リンクをコピーする</button>
                        </div>
                    </div>
                </div>
                <div class="col mt-3 d-block d-lg-none">
                    <div class="w-100 d-flex justify-content-center">
                        <button class="btn btn-info text-white">リンクをコピーする</button>
                    </div>
                </div>
            </div>
        </div>
