            ...
            <div class="justify-content-md-center row">
                <div class="col-12 col-md-4">
                    <div class="fs-14 card shadow rounded-4 p-4 pb-4 position-relative mr-5 mt-5">
                        <h6 class="fs-16 text-center mb-4 mt-3">Admin</h6>
                        <ul class="list-group border-0 text-overflow-hidden" id="show_profile">
                            <li class="list-group-item border-0 py-1"><i
                                    class="fa-solid fa-envelope me-2"></i>Admin@gmail.com
                            </li>
                            <li class="list-group-item border-0 py-1"><i
                                    class="fa-solid fa-mobile-screen-button me-2"></i><span id="show_phone">123 1234
                                    123</span></li>
                            <li class="list-group-item border-0 py-1"><i class="fa-regular fa-building me-2"></i><span
                                    id="show_name">Admin</span></li>
                            <li class="list-group-item border-0 py-1"><i class="fa-solid fa-key me-2"></i></li>

                        </ul>
                        <form action="" method="post" id="form_profile" class="d-none">
                            <ul class="list-group border-0 text-overflow-hidden">
                                <li class="list-group-item border-0 py-0">
                                    <i class="fa-solid fa-envelope me-2"></i>Admin@gmail.com
                                    <div class="invalid fs-12">
                                        Required
                                    </div>
                                </li>
                                <li class="list-group-item border-0 py-0">
                                    <i class="fa-solid fa-mobile-screen-button me-2"></i><input type="text"
                                        class="border-0 border-bottom" value="123 1234 1234" id="input_phone">
                                    <div class="invalid fs-12 text-danger">
                                        Required
                                    </div>
                                </li>
                                <li class="list-group-item border-0 py-0"><i
                                        class="fa-regular fa-building me-2"></i><input type="text"
                                        class="border-0 border-bottom " value="Admin" id="input_name">
                                    <div class="invalid fs-12 text-danger">
                                        Required
                                    </div>
                                </li>
                        ...
                        <div class="position-absolute fs-5" id="edit_profile" data-bs-toggle="modal"
                ...
                <div class="col-12 col-md-5 offset-md-1 fs-16 pt-5">
                    <div>
                        <span><i class="fa-regular fs-16 fa-building me-2"></i>Admin</span>
                    </div>
                    <div>
                    ...
                    <div class="w-100 d-flex fs-14">
                        <div class="w-auto d-flex me-2 align-items-center"><i
                                class="fa-solid fa-video me-2 text-main"></i></div>
                        <div class="d-flex flex-column flex-grow-1">
                            ...
                            <div class="text-end"><span>1000</span></div>
                        </div>
